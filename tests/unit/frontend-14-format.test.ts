...
describe('form validation - value formatting', () => {
...
describe('form validation - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 14');
    expect(err.message).toContain('fetching market 14');
