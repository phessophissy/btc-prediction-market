...
// responsive layout - input validation tests (PR 71)
...
describe('responsive layout - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-71')).toMatchObject({ valid: true }));
...
describe('responsive layout - boundary conditions', () => {
...
describe('responsive layout - numeric processing', () => {
