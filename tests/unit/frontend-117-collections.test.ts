...
// market card render - collection tests (PR 117)
...
describe('market card render - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 117, active: true }, { id: 118, active: false }];
...
describe('market card render - sorting', () => {
