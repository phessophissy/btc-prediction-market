...
// contract call params - collection tests (PR 69)
...
describe('contract call params - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 69, active: true }, { id: 70, active: false }];
...
describe('contract call params - sorting', () => {
