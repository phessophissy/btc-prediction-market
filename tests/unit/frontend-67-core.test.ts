...
// error boundaries - input validation tests (PR 67)
...
describe('error boundaries - input validation', () => {
  ...
  it('accepts valid', () => expect(validateInput('data-67')).toMatchObject({ valid: true }));
...
describe('error boundaries - boundary conditions', () => {
...
describe('error boundaries - numeric processing', () => {
