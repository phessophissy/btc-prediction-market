...
// emergency mode - input validation tests (PR 115)
...
describe('emergency mode - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-115')).toMatchObject({ valid: true }));
...
describe('emergency mode - boundary conditions', () => {
...
describe('emergency mode - numeric processing', () => {
