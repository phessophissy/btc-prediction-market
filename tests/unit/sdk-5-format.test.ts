...
describe('settlement flow - value formatting', () => {
...
describe('settlement flow - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 5');
    expect(err.message).toContain('fetching market 5');
