...
// contract call params - transform tests (PR 69)
...
describe('contract call params - data transform', () => {
  it('transforms complete data', () => {
    const m = transform({ 'market-id': { value: '69' }, 'title': { value: 'Test' }, 'total-pool': { value: '50000' }, 'settled': { value: false } });
    expect(m.id).toBe(69);
