...
// network switching - collection tests (PR 73)
...
describe('network switching - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 73, active: true }, { id: 74, active: false }];
...
describe('network switching - sorting', () => {
