...
// address validation - collection tests (PR 64)
...
describe('address validation - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 64, active: true }, { id: 65, active: false }];
...
describe('address validation - sorting', () => {
