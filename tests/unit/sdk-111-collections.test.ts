...
// market lifecycle - collection tests (PR 111)
...
describe('market lifecycle - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 111, active: true }, { id: 112, active: false }];
...
describe('market lifecycle - sorting', () => {
