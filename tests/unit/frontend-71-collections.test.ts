...
// responsive layout - collection tests (PR 71)
...
describe('responsive layout - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 71, active: true }, { id: 72, active: false }];
...
describe('responsive layout - sorting', () => {
