...
// fee estimation - transform tests (PR 74)
...
describe('fee estimation - data transform', () => {
  it('transforms complete data', () => {
    const m = transform({ 'market-id': { value: '74' }, 'title': { value: 'Test' }, 'total-pool': { value: '50000' }, 'settled': { value: false } });
    expect(m.id).toBe(74);
