...
describe('claim winnings calculations - input validation', () => {
  ...
  it('accepts valid standard input', () => {
    const result = validateInput('valid-test-data-6');
...
describe('claim winnings calculations - boundary conditions', () => {
...
describe('claim winnings calculations - numeric processing', () => {
...
describe('claim winnings calculations - collection operations', () => {
