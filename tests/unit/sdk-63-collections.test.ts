...
// pool calculation - collection tests (PR 63)
...
describe('pool calculation - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 63, active: true }, { id: 64, active: false }];
...
describe('pool calculation - sorting', () => {
