...
describe('error handling paths - input validation', () => {
  ...
  it('accepts valid standard input', () => {
    const result = validateInput('valid-test-data-11');
...
describe('error handling paths - numeric processing', () => {
...
describe('error handling paths - collection operations', () => {
