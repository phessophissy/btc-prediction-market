...
describe('odds calculation - value formatting', () => {
...
describe('odds calculation - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 13');
    expect(err.message).toContain('fetching market 13');
