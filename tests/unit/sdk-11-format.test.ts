...
describe('error handling paths - value formatting', () => {
...
describe('error handling paths - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 11');
    expect(err.message).toContain('fetching market 11');
