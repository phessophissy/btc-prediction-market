...
describe('claim winnings calculations - value formatting', () => {
...
describe('claim winnings calculations - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 6');
    expect(err.message).toContain('fetching market 6');
