...
// accessibility - input validation tests (PR 72)
...
describe('accessibility - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-72')).toMatchObject({ valid: true }));
...
describe('accessibility - boundary conditions', () => {
...
describe('accessibility - numeric processing', () => {
