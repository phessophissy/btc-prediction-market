...
// error boundaries - collection tests (PR 67)
...
describe('error boundaries - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 67, active: true }, { id: 68, active: false }];
...
describe('error boundaries - sorting', () => {
