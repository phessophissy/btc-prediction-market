...
// address validation - input validation tests (PR 64)
...
describe('address validation - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-64')).toMatchObject({ valid: true }));
...
describe('address validation - boundary conditions', () => {
...
describe('address validation - numeric processing', () => {
