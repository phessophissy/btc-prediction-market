...
// bet modal - input validation tests (PR 112)
...
describe('bet modal - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-112')).toMatchObject({ valid: true }));
...
describe('bet modal - boundary conditions', () => {
...
describe('bet modal - numeric processing', () => {
