...
// market serialization - transform tests (PR 65)
...
describe('market serialization - data transform', () => {
  it('transforms complete data', () => {
    const m = transform({ 'market-id': { value: '65' }, 'title': { value: 'Test' }, 'total-pool': { value: '50000' }, 'settled': { value: false } });
    expect(m.id).toBe(65);
