...
describe('market creation validation - input validation', () => {
  ...
  it('accepts valid standard input', () => {
    const result = validateInput('valid-test-data-3');
...
describe('market creation validation - boundary conditions', () => {
...
describe('market creation validation - numeric processing', () => {
...
describe('market creation validation - collection operations', () => {
