...
// clarity value parsing - input validation tests (PR 70)
...
describe('clarity value parsing - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-70')).toMatchObject({ valid: true }));
...
describe('clarity value parsing - boundary conditions', () => {
...
describe('clarity value parsing - numeric processing', () => {
