...
describe('bet placement logic - value formatting', () => {
...
describe('bet placement logic - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 4');
    expect(err.message).toContain('fetching market 4');
