...
describe('post condition building - value formatting', () => {
...
describe('post condition building - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 12');
    expect(err.message).toContain('fetching market 12');
