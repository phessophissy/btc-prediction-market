...
// emergency mode - collection tests (PR 115)
...
describe('emergency mode - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 115, active: true }, { id: 116, active: false }];
...
describe('emergency mode - sorting', () => {
