...
// clarity value parsing - transform tests (PR 70)
...
describe('clarity value parsing - data transform', () => {
  it('transforms complete data', () => {
    const m = transform({ 'market-id': { value: '70' }, 'title': { value: 'Test' }, 'total-pool': { value: '50000' }, 'settled': { value: false } });
    expect(m.id).toBe(70);
