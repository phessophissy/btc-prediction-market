...
describe('market creation validation - value formatting', () => {
...
describe('market creation validation - error handling', () => {
  it('wraps errors with context', () => {
    const err = wrapError(new Error('network timeout'), 'fetching market 3');
    expect(err.message).toContain('fetching market 3');
