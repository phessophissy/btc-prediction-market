...
// contract call params - input validation tests (PR 69)
...
describe('contract call params - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-69')).toMatchObject({ valid: true }));
...
describe('contract call params - boundary conditions', () => {
...
describe('contract call params - numeric processing', () => {
