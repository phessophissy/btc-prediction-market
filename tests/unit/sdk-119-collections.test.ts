...
// ownership transfer - collection tests (PR 119)
...
describe('ownership transfer - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 119, active: true }, { id: 120, active: false }];
...
describe('ownership transfer - sorting', () => {
