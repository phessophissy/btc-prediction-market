...
describe('odds calculation - input validation', () => {
  ...
  it('accepts valid standard input', () => {
    const result = validateInput('valid-test-data-13');
...
describe('odds calculation - boundary conditions', () => {
...
describe('odds calculation - numeric processing', () => {
...
describe('odds calculation - collection operations', () => {
