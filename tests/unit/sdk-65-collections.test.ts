...
// market serialization - collection tests (PR 65)
...
describe('market serialization - filtering', () => {
  it('filters active items', () => {
    const items = [{ id: 65, active: true }, { id: 66, active: false }];
...
describe('market serialization - sorting', () => {
