...
// network switching - input validation tests (PR 73)
...
describe('network switching - input validation', () => {
  it('rejects empty', () => expect(validateInput('')).toMatchObject({ valid: false }));
  it('accepts valid', () => expect(validateInput('data-73')).toMatchObject({ valid: true }));
...
describe('network switching - boundary conditions', () => {
...
describe('network switching - numeric processing', () => {
