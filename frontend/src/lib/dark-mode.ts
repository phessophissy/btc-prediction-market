...
export class DarkModeHandler {
  ...
  getConfig(): Readonly<DarkModeConfig> { return Object.freeze({ ...this.config }); }
  updateConfig(u: Partial<DarkModeConfig>): void { this.config = { ...this.config, ...u }; this.emit('config:updated', u); }
}
